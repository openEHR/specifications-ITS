...
|link:/releases/ITS-XML/AM/TOM/{its_xml_release}[Templating (OET based)]
...
|link:/releases/ITS-XML/AM/AOM2/{its_xml_release}[Archetype Model 2.x XSD]
|XML schema 1.1 expression of ADL/AOM 2.

		
2+^|Basic-Meta Model files (BMMs)

|link:/releases/ITS-BMM/BASE/{its_bmm_release}[BASE Model BMMs]
|BMM 2.x schema of the openEHR BASE component.

|link:/releases/ITS-BMM/RM/{its_bmm_release}[Reference component BMMs]
|BMM 2.x schema of the openEHR Reference Model.

|link:/releases/ITS-BMM/PROC/{its_bmm_release}[PROC component BMMs]
|BMM 2.x schema of the openEHR PROC component (Task Planning).

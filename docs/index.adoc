...
|link:/releases/ITS-XML/{its_xml_release}/components/BASE/latest[BASE draft XSDs]
|XML schema 1.0 expression of the openEHR latest Base Models.

|link:/releases/ITS-XML/{its_xml_release}/components/RM/Release-1.0.2[RM stable XSDs]
|XML schema 1.0 expression of the openEHR Reference Model Release-1.0.2.

|link:/releases/ITS-XML/{its_xml_release}/components/RM/latest[RM draft XSDs]
|XML schema 1.0 expression of the openEHR latest Reference Model.

|link:/releases/ITS-XML/{its_xml_release}/components/AM/Release-1.4[AM 1.4 XSDs]
...
|link:/releases/ITS-XML/{its_xml_release}/components/AM/latest[AM 2.x XSD]
|XML schema 1.1 expression the openEHR Archetype Model (ADL/AOM) 2.

|link:/releases/ITS-XML/{its_xml_release}/components/QUERY/latest[QUERY draft XSDs]

...
2+^|JSON Data Template (JDT)

|link:/releases/ITS-REST/{its_release}/json_data_template.html[JDT]
|JSON Data Template specification - a simplified data representation for committing data to the openEHR EHR.

...
|link:/releases/ITS-XML/{its_xml_release}/RM[RM XSDs]
|XML schema 1.0 expression of the openEHR Reference Model Release-1.0.2.

|link:/releases/ITS-XML/{its_xml_release}/AM/AOM1.4[AM 1.4 XSDs]
|XML schema 1.0 expression of the openEHR Archetype Model (ADL/AOM) 1.4.

|link:/releases/ITS-XML/{its_xml_release}/AM/TOM[Templating]
|Simple XML format for templates (OET based).

|link:/releases/ITS-XML/{its_xml_release}/AM/AOM2[AM 2.x XSD]
